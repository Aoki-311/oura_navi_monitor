...
class SecurityAndUiGuardrailsTest(unittest.TestCase):
    ...
    def test_export_jobs_are_the_frontend_export_path(self) -> None:
        ...
        self.assertIn("function defaultExportScope()", app_js)
        self.assertIn('return currentUserDetailContext().userId ? "user" : "all";', app_js)
        self.assertIn("function userExportIdentity()", app_js)
        self.assertIn('openExportDialog(defaultExportScope())', app_js)
        ...
        self.assertNotIn('openExportDialog("all")', app_js)
