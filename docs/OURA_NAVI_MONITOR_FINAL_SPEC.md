...
`analytics_tasks`；个人页才把“问的是什么主题”和“想完成什么任务”并列展示。
...
- `dashboard_user_list` 返回 80 人，73 人有历史，近 7 日 29 人活跃、104 条消息；
- `user_scope=83`；真实 API 返回主要分析 69、用户/地图 80、管理 83；
...
当前本地代码连接真实 BigQuery/Firestore 的 Chromium 验证：首页 69 人、10 地区、
